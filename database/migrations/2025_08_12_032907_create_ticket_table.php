...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tickets', function (Blueprint $table) {
            ...
            $table->foreignId('master_kat_informasi_id')->nullable()->constrained('master_kat_informasi')->onDelete('cascade');
            $table->foreignId('master_kat_keberatan_id')->nullable()->constrained('master_kat_keberatan')->onDelete('cascade');
            $table->string('nama_lengkap');
            $table->string('nomor_identitas');
            $table->string('lampiran_identitas');
            $table->string('lampiran_apbh')->nullable();
            $table->string('email');
            $table->string('no_telepon');
            $table->text('alamat');
            $table->string('tujuan_permohonan_informasi')->nullable();
            $table->string('tujuan_keberatan')->nullable();
            ...
            $table->string('penyalahgunaan_pejabat')->nullable();
            $table->string('penyalahgunaan_mitra')->nullable();
            $table->text('rincian_informasi');
            $table->string('lampiran_bukti_pejabat')->nullable();
            $table->string('lampiran_bukti_mitra')->nullable();
