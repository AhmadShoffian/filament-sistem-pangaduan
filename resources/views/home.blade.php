            ...
            <div class="w-full h-full flex flex-col justify-between relative z-10 p-8 lg:p-12 h-screen overflow-hidden">
                ...
                <div class="flex-grow flex flex-col justify-center py-4">
                    ...
                    <!-- <div class="w-full mx-auto rounded-xl overflow-hidden shadow-lg">
                        <img src="/src/images/hero/4.jpg" alt="Desa Digital" class="w-full h-auto object-cover" />
                    </div> -->
                </div>
            ...
            <div class="h-full max-w-md min-h-screen md:min-h-0 flex flex-col justify-between py-6">
                    ...
                    <form action="#" method="POST" class="space-y-5">
                        <div class="mb-6">
                            ...
                            <select name="subject" id="subject" required
                                ...
                                <option value="21">Permohonan Informasi</option>
                                <option value="22">Pengajuan Keberatan</option>
                                <option value="23">Pengaduan Pungli & Gratifikasi</option>
                                <option value="24">Pengaduan Penyalahgunaan Wewenang / Pelanggaran Pejabat</option>
                                <option value="25">Pengaduan Penyalahgunaan Wewenang / Pelanggaran Mitra Kerja</option>
                            </select>
                            ...
                            <div class="text-red-500 text-sm mt-1 hidden" id="subject-error">
                                <!-- Tempat validasi error jika diperlukan -->
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="applicant" id="applicant" required
                                    ...
                                    <option value="11">Perorangan</option>
                                    <option value="12">Kelompok</option>
                                    <option value="13">LSM/NGO</option>
                                    <option value="14">Instansi Pemerintah</option>
                                    <option value="15">Lembaga Pemerintah</option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="identity"
                                ...
                                required pattern="\d*">
                            <p class="text-red-500 text-sm mt-1 hidden" id="identity-error">Nomor identitas wajib diisi.
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input id="phone" type="tel" name="handphone" required placeholder="082121346578"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                        ...
                        <div class="flex flex-col md:flex-row md:space-x-6 mb-6 pejabat">
                            <div class="w-full md:w-1/2 mb-4 md:mb-0">
                                <label class="block text-gray-700 font-semibold mb-2">
                                    Nama Pejabat <span class="text-red-500">*</span>
                                </label>
                                <input type="text" name="placeman"
                                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    value="" />
                                <div class="text-red-500 text-sm mt-1 hidden" id="placeman-error">
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <input type="text" name="position"
                                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    value="" />
                                <div class="text-red-500 text-sm mt-1 hidden" id="position-error">
                                    <!-- Pesan error jika ada -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            <label class="block text-gray-700 font-semibold mb-2 require">
                                <span class="rincian">Rincian Informasi</span>
                                <span class="pejabat">Penyalahgunaan yang dilakukan</span>
                                <span class="tujuan">Tujuan mengajukan keberatan</span>
                            </label>

                            <textarea name="description" required
                                class="w-full border border-gray-300 rounded-md px-4 py-2 min-h-[120px] focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <select id="category" name="category" required
                                ...
                                <option value="">Pilih kategori</option>
                                <option value="1">Akademik (Registrasi, Perkuliahan, KKN dan Akreditasi)</option>
                                <option value="2">Kemahasiswaan (Beasiswa, Kegiatan Mahasiswa, Alumni)</option>
                                <option value="3">Keuangan dan BMN</option>
                                <option value="4">Penelitian dan Pengabdian kepada Masyarakat</option>
                                <option value="5">Teknologi dan Sistem Informasi</option>
                                <option value="6">Sarana dan Prasarana</option>
                                <option value="7">Tata Kelola dan Komunikasi publik</option>
                                <option value="8">Kerja Sama</option>
                                <option value="9">Inovasi, Korporasi akademik dan Usaha</option>
                                <option value="10">Perencanaan</option>
                            </select>
                            <p class="text-red-500 text-sm mt-1 hidden" id="category-error">Kategori wajib dipilih.</p>
                        </div>

                        <div class="mb-6">
                            <label class="block font-semibold text-gray-700 mb-2">
                                <span class="rincian">Lampiran Data Dukung (optional)</span>
                                <span class="pejabat hidden">Berkas Bukti</span>
                                <span class="text-red-500">*</span>
                            </label>

                            <div class="flex items-center">
                                <input type="file" name="sfiles" id="sfiles" class="block w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4
             ...
             border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
                            ...
                            <p class="text-sm text-gray-500 mt-2">
                                File berekstensi <strong>.doc, .docx, .pdf, .jpeg, .png, .jpg</strong> dengan ukuran
                                maksimal <strong>1Mb</strong>
                            </p>

                            <div class="text-red-500 text-sm mt-1 hidden" id="sfiles-error">
                                <!-- Tempat error message jika validasi gagal -->
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" name="objection[]" value="1"
                                        class="form-checkbox text-emerald-600">
                                    <span>Permohonan ditolak</span>
                                </label>
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" name="objection[]" value="2"
                                        class="form-checkbox text-emerald-600">
                                    <span>Informasi berkala tidak disediakan</span>
                                </label>
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" name="objection[]" value="3"
                                        class="form-checkbox text-emerald-600">
                                    <span>Permintaan informasi tidak ditanggapi</span>
                                </label>
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" name="objection[]" value="4"
                                        class="form-checkbox text-emerald-600">
                                    <span>Permintaan informasi ditanggapi tidak sebagaimana yang diminta</span>
                                </label>
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" name="objection[]" value="5"
                                        class="form-checkbox text-emerald-600">
                                    <span>Permohonan informasi tidak dipenuhi</span>
                                </label>
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" name="objection[]" value="6"
                                        class="form-checkbox text-emerald-600">
                                    <span>Biaya yang dikenakan tidak wajar</span>
                                </label>
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" name="objection[]" value="7"
                                        class="form-checkbox text-emerald-600">
                                    <span>Informasi yang disampaikan melebihi jangka waktu yang ditentukan</span>
                                </label>
                            </div>

                            <p class="text-red-500 text-sm mt-2 hidden" id="objection-error">Silakan pilih minimal satu
                                alasan keberatan.</p>
                        </div>
                        ...
                        <div class="mb-6 info">
                            ...
                            <select name="getinfo"
                                ...
                                <option value="langsung">Mengambil Langsung ke Unpad</option>
                                <option value="pos">Melalui Pos</option>
                                <option value="email">Melalui Email atau Website</option>
                                <option value="faksimile">Melalui Faksimile</option>
                            </select>
                ...
                <!-- Mobile Footer -->
                <div class="text-center text-sm text-gray-600 mt-auto pt-8 md:hidden">&copy; 2025 UPA TIK ISI Yogyakarta
                </div>
            </div>
        </div>
    </div>
