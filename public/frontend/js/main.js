...
$(document).ready(function() {
    ...
    function o() {
        n.addClass("open"),
        a.addClass("sidenav-open")
    }
    function r() {
        n.removeClass("open"),
        a.removeClass("sidenav-open")
    }
    function u() {
        l.addClass("open"),
        t.addClass("open")
    ...
    n.find(".nav-item").on("mouseenter", function(e) {
        ...
        n.addClass("active"),
        u()) : d(),
        l.find(".childNav").hide(),
        l.find('[data-parent="' + a + '"]').show()
    }),
    ...
    e.on("click", function(e) {
        ...
        t && a && gullUtils.isMobile() ? (r(),
        d()) : t && a ? d() : t ? r() : t || a || i ? t || a || (o(),
        u()) : o()
    });
    var v = $(".search-ui");
    c.on("focus", function() {
